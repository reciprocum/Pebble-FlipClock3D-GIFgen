/*
   File  : SegmentDisplay2D_N7SKINBONE.c
   Author: Afonso Santos, Portugal

   Last revision: 12h35 August 08 2016
*/
...
const I2_8_PathInfo SEG_N7SKINBONE_VERTEXINFO
= { .pointsNum = 20
  , .points    = (I2_8[])
                 { { 120, 120 }   // v0   (skin)
                 , { 120,   0 }   // v1   (skin)
...
const EdgeInfo SEG_N7SKINBONE_EDGEINFO
= { .edgesNum = 31
  , .edges    = (Edge[])
                { {  0,  1 }      // e0   (skin)
                , {  1,  2 }      // e1   (skin)
...
const unsigned char *SEG_N7SKINBONE_DIGIT_EDGEMAP_L2R[10]                 // IMPORTANT: use left to right (L2R) bit indexing methods when decoding.
