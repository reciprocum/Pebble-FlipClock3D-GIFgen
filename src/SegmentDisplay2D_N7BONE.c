/*
   File  : SegmentDisplay2D_N7BONE.c
...
const I2_8_PathInfo SEG_N7BONE_VERTEXINFO
= { .pointsNum = 6
  , .points    = (I2_8[])
                 { { 120, 120 }     // v0
                 , { 120,   0 }     // v1
...
const EdgeInfo SEG_N7BONE_EDGEINFO
= { .edgesNum = 7
  , .edges    = (Edge[])
                { { 0, 1 }      // e0: v0 v1
                , { 1, 2 }      // e1: v1 v2
...
const unsigned char *SEG_N7BONE_DIGIT_EDGEMAP_L2R[10]     // IMPORTANT: use left to right (L2R) bit indexing methods when decoding.
