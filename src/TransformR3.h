/*
   ...
   Last revision: 17h05 July 31 2016
*/
...
TransformR3*  TransformR3_setRotation      ( TransformR3 *this, const float rotationX, const float rotationY, const float rotationZ ) ;
Matrix34*     TransformR3_getTransformation( TransformR3 *this ) ;
R3*           TransformR3_rotateX          ( R3 *this, const float  rotation ) ;
R3*           TransformR3_rotateY          ( R3 *this, const float  rotation ) ;
R3*           TransformR3_rotateZ          ( R3 *this, const float  rotation ) ;