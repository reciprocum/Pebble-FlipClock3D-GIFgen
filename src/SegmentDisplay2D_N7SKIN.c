/*
   File  : SegmentDisplay2D_N7SKIN.c
...
const I2_8_PathInfo SEG_N7SKIN_VERTEXINFO
= { .pointsNum = 14
  , .points    = (I2_8[])
                 { { 120, 120 }   // v0   (skin)
                 , { 120,   0 }   // v1   (skin)
...
const EdgeInfo SEG_N7SKIN_EDGEINFO
= { .edgesNum = 24
  , .edges    = (Edge[])
                { {  0,  1 }      // e0   (skin)
                , {  1,  2 }      // e1   (skin)
...
const unsigned char *SEG_N7SKIN_DIGIT_EDGEMAP_L2R[10]         // IMPORTANT: use left to right (L2R) bit indexing methods when decoding.
