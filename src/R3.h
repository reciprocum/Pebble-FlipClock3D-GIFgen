...
#define R3_origin        ((R3){ .x = 0.0, .y = 0.0, .z = 0.0 })
#define R3_versorPlusX   ((R3){ .x =+1.0, .y = 0.0, .z = 0.0 })
#define R3_versorMinusX  ((R3){ .x =-1.0, .y = 0.0, .z = 0.0 })
#define R3_versorPlusY   ((R3){ .x = 0.0, .y =+1.0, .z = 0.0 })
#define R3_versorMinusY  ((R3){ .x = 0.0, .y =-1.0, .z = 0.0 })
#define R3_versorPlusZ   ((R3){ .x = 0.0, .y = 0.0, .z =+1.0 })
#define R3_versorMinusZ  ((R3){ .x = 0.0, .y = 0.0, .z =-1.0 })
...
// c := a - b
R3*    R3_subtract( R3 *c, const R3 *a, const R3 *b ) ;
