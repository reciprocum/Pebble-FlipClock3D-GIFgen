/*
   File  : SegmentDisplay2D_NCURVYBONE.c
...
const I2_8_PathInfo SEG_NCURVYBONE_VERTEXINFO
= { .pointsNum = 25
  , .points    = (I2_8[])
                 { {-120,+120 }   // v0
                 , { -60,+120 }   // v1
...
const EdgeInfo SEG_NCURVYBONE_EDGEINFO
= { .edgesNum = 37
  , .edges    = (Edge[])
                { {  1,  3 }      // e0
                , {  3,  6 }      // e1
...
const unsigned char *SEG_NCURVYBONE_DIGIT_EDGEMAP_L2R[10]                             // IMPORTANT: use left to right (L2R) bit indexing methods when decoding.
